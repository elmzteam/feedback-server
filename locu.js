// From https://github.com/Locu-Unofficial/locu-node (but patched)
...
LocuClient.prototype._request = function(url, params, cb){
  ...
  this.__request.post({url: url, body: params, json: true}, function(err, resp){
...
function LocuClient(api_key, server_url, version_str){
  ...
  this.api_version_str = version_str || 'v2';
